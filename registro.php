...
IMPRESO,BITACORA,ESTATUS1,DISENADOR,ORDENDOS,CAPTURA,OBSERVACIONES,AUTORIZA,TIPOIM,NOPAPEL,TIPOPAPEL,NOIMPRESIONES) 
VALUES('$numero','$FECHA','$MEMO','$ORDEN','$PROYECTO','$INFO','$IMAGEN','$LOGOS','$DETALLES','$RESPONSABLE','$TEL','$AREA','$CORREO','$FECHADOS',
'$IMPRESO','$BITACORA','$ESTATUS1','$DISENADOR','$ORDENDOS','$CAPTURA','$OBSERVACIONES','$AUTORIZA','$TIPOIM','$NOPAPEL','$TIPOPAPEL','$NOIMPRESIONES')") or die("<h2>Error Guardando los datos</h2>");
