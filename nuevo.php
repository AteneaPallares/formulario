...
<?php include 'php/autorizando.php';?>
    <div class="col-sm-12 col-xs-12 seccion">
        ...
        <div class=" col-sm-6 col-xs-12 elementos">
            ...
            <select <?php echo $Hmemo;?> name="disenador" onchange="agregarusuario();reporte()" ; id="disenador">
                <?php
                include 'php/conectar.php';
    ...
    <div class="col-sm-12 col-xs-12 seccion">
        ...
        <div class=" col-sm-12 col-xs-12">
            <fieldset>
                ...
                <label>Vobo<img id="radio" src="imagenes/vobo.png"><input type="radio" name="estatus"
                        value="4"
